...
namespace DataMagic.MongoDatabase.Extensions
{
	public static class NumericSearchExtensions
	{
		...
		/// <returns></returns>
		public static IMongoQueryable<T> WithNumericSearch<T, TValueType>(this IMongoQueryable<T> items,
		...
		/// <param name="range"></param>
		/// <returns></returns>
		public static IMongoQueryable<T> WithNumericRangeSearch<T, TValueType>(this IMongoQueryable<T> items,
			Expression<Func<T, TValueType>> property,
