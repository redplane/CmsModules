...
namespace MailWeb.Cqrs.CommandHandlers.ClientSettings
{
    public class AddClientSettingCommandHandler : IRequestHandler<AddClientSettingCommand, ClientSetting>
    {
        ...
        public AddClientSettingCommandHandler(MailManagementDbContext dbContext, IMailClientsManager mailServiceFactory)
        {
            ...
            CancellationToken cancellationToken)
        {
            var activeMailService =
                await _mailServiceFactory.GetMailClientsAsync(command.UniqueName, cancellationToken);
